      ...
      <div className="w-[1280px] h-[585px] flex flex-col gap-[64px] pt-[76px] pb-[96px] pr-[160px] pl-[160px] bg-[#D9BFA8]/10">
        ...
        <div className="w-[960px] h-[274px] flex justify-between items-center gap-[32px]">
          <InvisibleToGuestsCard
            icon={<Search className="w-[30px] h-[28.5px] text-[#D9BFA8]" />}
          ...
          />
          <InvisibleToGuestsCard
            icon={<Banknote className="w-[30px] h-[28.5px] text-[#D9BFA8]" />}
          ...
          />
          <InvisibleToGuestsCard
            icon={<TrendingDown className="w-[30px] h-[28.5px] text-[#D9BFA8]" />}
