          ...
          <div className="max-w-[520px]">
            ...
            <div className="mb-6">
              <h1 className="font-extrabold text-[32px] leading-tight tracking-tight">
                <span className="text-[#5C3317]">Secure, Seamless</span>

                <br />

                <span className="text-[#8B4513]">Payments</span>

                <span className="text-[#5C3317]"> For your Hotel</span>
              </h1>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <a
                href="/contact"
                target="_blank"
                className="w-[170px] h-12 rounded-xl bg-[#8B4513] text-white text-sm font-semibold cursor-pointer flex items-center justify-center"
              >
                Start Contact
              </a>
              ...
              <a
                ...
                target="_blank"
                className="w-[170px] h-12 rounded-xl bg-[#F5E6D3] border border-[#d4a567] text-sm font-semibold cursor-pointer flex items-center justify-center"
              >
                View Prices
              </a>
            </div>
