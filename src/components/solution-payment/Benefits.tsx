...
export default function Benefits() {
  return (
    <section className="w-full mt-6 flex justify-center items-center">
      <div className="relative flex w-[80%] justify-center items-center h-[640px] rounded-[32px] bg-[#1152D4]">
        <div className="bg-white/3 w-[256px] h-[256px] absolute -top-30 -right-30 rounded-[9999px]"></div>
        ...
        <div className="w-[1150px] h-[512px] flex justify-center gap-[30px]">
          <div className="w-[520px] h-[388px] flex flex-col gap-[20px]">
            <div className="w-[520px] h-[80px]">
              <span className="text-white text-[36px] font-extrabold">
