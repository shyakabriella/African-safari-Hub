        ...
        <div className="w-full max-w-[960px] rounded-[32px] bg-[#8B4513] flex flex-col justify-center items-center text-center px-12 py-12">
          <div className="w-full flex flex-col gap-8">
            ...
            <div className="w-full">
              <span className="font-extrabold text-[20px] leading-[1.1] text-white block">
            ...
            {/* Description */}
            <div className="w-full">
              <span className="font-normal text-[13px] leading-[32px] text-[#F1F5F9] block">
            ...
            {/* Footer Text */}
            <div className="w-full">
              <span className="text-[12px] text-white/80 leading-[20px]">
