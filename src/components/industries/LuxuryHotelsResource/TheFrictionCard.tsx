interface TheFrictionCardProps {
  icon: React.ReactNode;
  title: string;
  description: string;
}

export default function TheFrictionCard({
  icon,
  title,
  description,
}: TheFrictionCardProps) {
  return (
    <div className="w-[352px] h-[282px] flex flex-col gap-[16px] p-[32px] rounded-[16px] bg-white border border-[#8B4513]/10">
