...
export default function GuesHouseCTA() {
  return (
      ...
      <div className="w-[768px] h-[470px] flex flex-col items-center text-center gap-[30px] pt-[96px] pr-[80px] pl-[80px] bg-[#8B4513]/5 border border-[#8B4513]/20">
          ...
          <div className="w-[606px]">
            <span className="w-[499.1px] h-full font-bold text-[30px] leading-[48px] text-[#0F172A]">
              Ready to simplify your hospitality?
            </span>
          </div>

          <div className="w-[606px] h-[56px]">
            <span className="text-[#727c89] leading-[28px] text-[14px] font-normal">
              Join 500+ guesthouses and lodges worldwide who have automated their admin to focus on their guests.
            </span>
          </div>
