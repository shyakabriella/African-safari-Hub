...
// src/components/core-solutions/ai/PowerfulAI.tsx
import { BarChart3, MessageSquare, Sparkles } from "lucide-react";
import PowerfulAICard from "./PowerfulAICard";
...
export default function PowerfulAI() {
  ...
  return (
    <div className="w-full py-16 px-4 md:px-8 lg:px-20 bg-[#F8FAFC]">
      <div className="max-w-7xl mx-auto">
        
        {/* Header */}
        <div className="text-center mb-12">
          <div className="mb-4">
            <span className="text-sm font-bold tracking-[1.4px] text-[#8B4513]">
              PLATFORM CAPABILITIES
            </span>
          </div>
          ...
          <p className="text-base md:text-lg text-[#475569] max-w-2xl mx-auto">
            Our platform integrates seamlessly with your existing systems to automate communication and provide actionable data.
          </p>
        </div>
