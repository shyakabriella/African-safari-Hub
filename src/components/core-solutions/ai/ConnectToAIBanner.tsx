        ...
        <div className="w-full lg:w-1/2 flex flex-col gap-5">
          <div className="flex flex-col gap-3">
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-tight">
              <span className="text-[#0F172A]">Connect Your Hotel to the </span>
              <span className="text-[#8B4513]">Future of AI</span>
            </h1>
          </div>

          <p className="text-sm md:text-base text-[#475569] leading-relaxed">
            Enhance guest satisfaction with 24/7 automated support, smart AI
            replies, and insights that drive revenue.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-2 w-full">
            <a
              href="/contact"
              target="_blank"
              className="w-full px-5 py-2.5 rounded-lg bg-[#8B4513] text-white text-sm font-semibold hover:bg-[#6B3410] transition whitespace-nowrap flex items-center justify-center"
            >
              Contact
            </a>
          </div>
